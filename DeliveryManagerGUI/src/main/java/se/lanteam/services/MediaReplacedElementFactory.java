...
public class MediaReplacedElementFactory implements ReplacedElementFactory {
    ...
    public MediaReplacedElementFactory(ReplacedElementFactory superFactory, String imagesFolder) {
    ...
    public ReplacedElement createReplacedElement(LayoutContext layoutContext, BlockBox blockBox, UserAgentCallback userAgentCallback, int cssWidth, int cssHeight) {
        ...
        if ("div".equals(nodeName) && "media".equals(className)) {
            ...
            try {
                input = new FileInputStream(imagesFolder + element.getAttribute("data-src"));
