...
public class StatusConstants {
	...
	public static final String[] ACTIVE_STATI = {ORDER_STATUS_RECEIVING, ORDER_STATUS_NEW, ORDER_STATUS_STARTED, ORDER_STATUS_REGISTRATION_DONE, ORDER_STATUS_ROUTE_PLANNED, ORDER_STATUS_NOT_ACCEPTED};
