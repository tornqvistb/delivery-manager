...
insert into system_user (id,first_name,last_name,password,role,user_name) values (1,'Lim','User','VLC2019!','common-user','lim');
insert into system_user (id,first_name,last_name,password,role,user_name) values (2,'Lim','Administrator','Pl@ttform1','administrator','admin');
