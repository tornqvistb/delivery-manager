...
public class ObjectFactory {
    ...
    private final static QName _ArrayOfGBCA003AErrorResponseLine_QNAME = new QName("http://lanteam.se/ws/GbgIntraservice", "ArrayOfGBCA003A_ErrorResponseLine");
    private final static QName _GBCA003AErrorResponse_QNAME = new QName("http://lanteam.se/ws/GbgIntraservice", "GBCA003A_ErrorResponse");
    private final static QName _GBCA003AErrorResponseLine_QNAME = new QName("http://lanteam.se/ws/GbgIntraservice", "GBCA003A_ErrorResponseLine");
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link ArrayOfGBCA003AErrorResponseLine }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://lanteam.se/ws/GbgIntraservice", name = "ArrayOfGBCA003A_ErrorResponseLine")
    public JAXBElement<ArrayOfGBCA003AErrorResponseLine> createArrayOfGBCA003AErrorResponseLine(ArrayOfGBCA003AErrorResponseLine value) {
        return new JAXBElement<ArrayOfGBCA003AErrorResponseLine>(_ArrayOfGBCA003AErrorResponseLine_QNAME, ArrayOfGBCA003AErrorResponseLine.class, null, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://lanteam.se/ws/GbgIntraservice", name = "GBCA003A_ErrorResponse")
    public JAXBElement<GBCA003AErrorResponse> createGBCA003AErrorResponse(GBCA003AErrorResponse value) {
        return new JAXBElement<GBCA003AErrorResponse>(_GBCA003AErrorResponse_QNAME, GBCA003AErrorResponse.class, null, value);
    }

    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link GBCA003AErrorResponseLine }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://lanteam.se/ws/GbgIntraservice", name = "GBCA003A_ErrorResponseLine")
    public JAXBElement<GBCA003AErrorResponseLine> createGBCA003AErrorResponseLine(GBCA003AErrorResponseLine value) {
        return new JAXBElement<GBCA003AErrorResponseLine>(_GBCA003AErrorResponseLine_QNAME, GBCA003AErrorResponseLine.class, null, value);
    }
