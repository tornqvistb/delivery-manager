...
public class SchedulerConfig {
    ...
    public SchedulerFactoryBean schedulerFactoryBean(DataSource dataSource, JobFactory jobFactory,
                                                     @Qualifier("orderTransmitJobTrigger") Trigger orderTransmitJobTrigger) throws IOException {
        ...
        factory.setTriggers(orderTransmitJobTrigger);
    ...
    @Bean
    public JobDetailFactoryBean orderTransmitJobDetail() {
        return createJobDetail(OrderTransmitJob.class);
    }
